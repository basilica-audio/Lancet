...
TEST_CASE ("State round-trip preserves every bool parameter (On/Listen, every band)", "[state]")
{
    ...
    static constexpr const char* boolIds[] = {
        ParamIDs::b1On, ParamIDs::b1Listen, ParamIDs::b1AutoRelease, ParamIDs::b1GainQ, ParamIDs::b1Sat,
        ParamIDs::b2On, ParamIDs::b2Listen, ParamIDs::b2AutoRelease, ParamIDs::b2GainQ, ParamIDs::b2Sat,
        ParamIDs::b3On, ParamIDs::b3Listen, ParamIDs::b3AutoRelease, ParamIDs::b3GainQ, ParamIDs::b3Sat, // Band 3 defaults On - still round-trips like every other bool
        ParamIDs::b4On, ParamIDs::b4Listen, ParamIDs::b4AutoRelease, ParamIDs::b4GainQ, ParamIDs::b4Sat,
        ParamIDs::b5On, ParamIDs::b5Listen, ParamIDs::b5AutoRelease, ParamIDs::b5GainQ, ParamIDs::b5Sat,
        ParamIDs::b6On, ParamIDs::b6Listen, ParamIDs::b6AutoRelease, ParamIDs::b6GainQ, ParamIDs::b6Sat,
    };
